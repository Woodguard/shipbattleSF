...
class BoardOut(BoardError):
    def __str__(self):
        return "Ваш залп попал за клетку"


class BoardRepeat(BoardError):
    def __str__(self):
        return "Вы попали туда же"
        ...
        for ship in self.ships:
            if d in ship.dots:
                ...
                if ship.heart == 0:
                    ...
                    print("Кораблю оператора уничтожен")
                    return False
                else:
                    print("Вам удалось попасть в корабль Оператор")
                    return True
...
class II(Player):
    def ask(self):
        ...
        print(f"Время оператору показать себя: {d.x + 1} {d.y + 1}")
        return d
    ...
    def ask(self):
        while True:
            ...
            if not (x.isdigit()) or not (y.isdigit()):
                print("Возможно использование только чисел")
                continue
...
class Game:
    ...
    def greet(self):
        print("Добро пожаловать в мир борьбы на воде. Оператор бросает вам вызов")
    ...
    def loop(self):
        ...
        while True:
            ...
            if num % 2 == 0:
                ...
                print("-" * 20)
                print("Оператор совершает действие")
                repeat = self.ii.move()
            if repeat:
                num -= 1
            ...
            if self.ii.board.count == 7:
                print("-" * 20)
                print("В этот раз тебе удалось победить")
                break
